...
public class ProductListFormatterTest {
    ...
    public void testSmartPhoneProductListFormatting() {
      ...
      StringBuffer sb = new StringBuffer();
      sb.append("product 1 IPhone 10 (111-222-333), numberOfCPUs: 3, color: \"Black\", ramSize: 1024.0, screenResolution: \"10x10\", manufacturer: \"Apple\"\n");
      sb.append("product 2 IPhone 7 (111-222-444), numberOfCPUs: 3, color: \"Red\", ramSize: 1024.0, screenResolution: \"10x10\", manufacturer: \"Apple\"\n");
      String expected = sb.toString();
    ...
    public void testAllProductListFormatting() {
      ...
      StringBuffer sb = new StringBuffer();
      sb.append("product 1 Cool Backpack (111-222-333), maxContentWeight: 15.0, color: \"Black\", capacity: 20.0\n");
      sb.append("product 2 IPhone 10 (111-222-333), numberOfCPUs: 3, color: \"Black\", ramSize: 1024.0, screenResolution: \"10x10\", manufacturer: \"Apple\"\n");      
      String expected = sb.toString();
